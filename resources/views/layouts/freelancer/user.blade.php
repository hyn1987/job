...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets/plugins/jcrop/css/jquery.Jcrop.css') }}">
  <link rel="stylesheet" href="{{ url('assets/plugins/jcrop/css/jquery.Jcrop.min.css') }}">
...
<body class="layout layout-freelancer freelancer-page {{ str_replace('.', '-', $page) }}">
  ...
  <div class="page-wrapper page-user">
    <div class="page-section container">
      ...
      <div class="row">
        <div class="col-sm-3">
          @include('layouts.freelancer.section.user_sidebar_menu')
        </div>
