...
<body class="layout layout-freelancer freelancer-page freelancer-payment-page {{ str_replace('.', '-', $page) }}">
  @include('layouts.section.header')

  <!-- BEGIN CONTENT -->
  <div class="page-wrapper page-payment">
    <div class="page-section container">
      <div class="row">
        <div class="page-content col-sm-offset-1 col-sm-10">
          @yield('content')
        </div>
      </div>
    </div>
