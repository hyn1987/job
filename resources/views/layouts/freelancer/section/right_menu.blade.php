...
/**
* Header for Freelancer Pages
* @author 	nada
* @since 	12/25/2015
*/
?>
<div class="right-menu freelancer-right-menu">
  <ul class="nav navbar-nav pull-right">
      ...
      <div class="search-form dropdown-menu">
        <form id="frm_header_search" class="form-inline" action="{{ route('search.job') }}" method="post">
          ...
          <div class="input-group">
            <input type="text" placeholder="Search" class="form-control" name="search_title">
    ...
    <li class="dropdown dropdown-extended dropdown-inbox" id="header_help_bar">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="">
          <a href="{{route('ticket.list')}}">Ticket</a>
        </li>
      </ul>
    </li>
    <!-- END Help DROPDOWN -->
    ...
    <li class="dropdown dropdown-extended dropdown-tasks" id="header_notification_bar">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="notification-all">
          <a href="{{route('notification.list')}}">See all notifications</a>
        </li>
      </ul>
    </li>
    <!-- END TODO DROPDOWN -->
        ...
        @foreach ($right_menu as $root_key => $root)
          ...
          <li>
            <a href="{{ $root['route'] ? route($root['route']) : 'javascript:;' }}">
              ...
              <i class="{{ $root['icon'] }}"></i>
              @endif
              {{ trans('menu.freelancer_right_menu.' . $root_key . '.title') }} 
            </a>
          </li>
          @endif
        @endforeach
