...
<head>
  <meta charset="utf-8">
  <title>{{ trans('page.' . $page . '.title', ['contract' => $contract->title]) }} - {{ trans('page.title') }}</title>
...
<body class="layout layout-buyer buyer-page buyer-contract-page {{ str_replace('.', '-', $page) }}">
