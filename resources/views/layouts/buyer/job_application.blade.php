...
<head>
  <meta charset="utf-8">
  <title>{{ trans('page.' . $page . '.title', ['job' => $job->subject, 'contractor' => $application->user->fullname()]) }} - {{ trans('page.title') }}</title>
...
<body class="layout layout-buyer buyer-page buyer-job-application-page {{ str_replace('.', '-', $page) }}">
