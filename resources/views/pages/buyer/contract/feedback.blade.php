          ...
          <div class="form-body">
            ...
            <div class="form-group">
              <label class="col-sm-2">
                <span class="pull-right"><strong>{{ trans('contract.rate') }}:&nbsp</strong></span>
              </label>
              <div class="col-sm-10">
                <div class="form-line-wrapper clearfix" id="pulsate-regular" style="padding:5px 0px;margin:0 5px;">
                  <input name="rate" type="radio" class="rate required" value="1" {{ $rate == 1 ? 'checked="checked"' : ''}} data-rule-required="true" /> 
