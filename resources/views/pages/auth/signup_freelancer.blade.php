...
<div id="main_body" class="container-fluid">
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3">
			<div class="summary-block form-group">
				<div class="text-center title_1">{{ trans('page.auth.signup.freelancer.title')}}</div>
			...
			<div id="register_panel">
				<form id="frm_register" method="post" action="{{ route('user.signup.freelancer') }}{{$param}}">
